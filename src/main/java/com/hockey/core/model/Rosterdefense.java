...
public class Rosterdefense {
	...
	public Rosterdefense() {
	}

	public Rosterdefense(Integer id, Integer rosterId, Boolean isActive, Integer currentTeamId, Integer seasonYear, String seasonType, Integer gamesAssists, 
